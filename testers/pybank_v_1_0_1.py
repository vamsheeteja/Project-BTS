...
def finish_verify():
    ...
    finish_verify_screen = Toplevel(verify_screen)
...
def verify():
    ...
    # except e:
    #     print("in except")
    #     emsg = "enter a valid phone number*"+str(e)
    ...
    # phone_verify screen
    verify_screen = Toplevel(register_screen)
    ...
    # button
    Button(verify_screen, text="Register", command = finish_verify, font=("Calibri", 12)).grid(row=5, sticky=N, pady=10)
